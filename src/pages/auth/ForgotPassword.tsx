...
const mockUsers = [
  { email: "admin@hotel.com", name: "Admin User" },
  { email: "manager@hotel.com", name: "Hotel Manager" },
  { email: "staff@hotel.com", name: "Staff Member" },
  { email: "reception@hotel.com", name: "Reception Desk" },
];
...
export const ForgotPassword: React.FC = () => {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    ...
    if (!validateRequired(email)) {
      ...
      // Check if email exists in mock user database
      const userExists = mockUsers.find(
        (user) => user.email.toLowerCase() === email.toLowerCase()
      );
      if (!userExists) {
        newErrors.email = "Email not found in our system. Please check and try again.";
      }
    }
    ...
    try {
      ...
      // Display OTP in console for easy testing
      ...
      console.log("=".repeat(50));
      console.log("💡 Tip: Copy the OTP from above to verify");
      console.log("=".repeat(50));
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mb-2">
                      Use any of these test emails to try the forgot password flow:
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {mockUsers.map((user) => (
                        <button
                          ...
                          className="text-xs px-2 py-1 bg-white border border-blue-200 rounded-md hover:bg-blue-50 hover:border-blue-400 transition-colors text-blue-700 font-medium"
                        >
                          {user.email}
                        </button>
                      ))}
