  ...
  const policies = useMemo(
    () =>
      state.policies.filter(
        (p) =>
          p.category.toLowerCase().includes("cancellation") &&
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-slate-600">
            Manage cancellation and refund policies.
          </p>
        </div>
        <Button
          onClick={() => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          <div className="p-4">
            ...
            <p className="text-3xl font-bold text-amber-600">Cancellation</p>
          </div>
        </Card>
      </div>
      ...
      <Card>
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 p-4 border-b border-slate-100">
          <h3 className="text-lg font-semibold">All Cancellation Policies</h3>
          <Input
            label=""
      ...
      <Modal
        ...
        title={
          editingPolicy ? "Edit Cancellation Policy" : "Add Cancellation Policy"
        }
        footer={
          <>
            <Button
      ...
      >
        <div className="space-y-4">
          <Input
            ...
            placeholder="e.g., Flexible - 1 day free cancel"
            required
          />
          <div>
            ...
            <textarea
              ...
              placeholder="Explain refund %, deadline, and penalties"
              required
            />
          </div>
        </div>
